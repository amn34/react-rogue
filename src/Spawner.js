...
const MonsterTable = [
    ...
    {name: 'Snake', color: 'green', ascii: 'S', offset: {x: 2, y: 3}, health: 3},
    {name: 'Rat', color: 'darkgrey', ascii: 'R', offset: {x: 2, y: 3}, health: 2},
    {name: 'Penguin', color: 'blue', ascii: 'P', offset: {x: 2, y: 3}, health: 10},
];
